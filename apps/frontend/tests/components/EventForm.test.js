...
const AllProviders = ({ children }) => {
    ...
    return (_jsx(SpectrumProvider, { theme: defaultTheme, children: _jsx(QueryClientProvider, { client: queryClient, children: children }) }));
};
describe('EventForm', () => {
    const mockTeamId = '660e8400-e29b-41d4-a716-446655440001';
    it('should render all form fields', () => {
        render(_jsx(AllProviders, { children: _jsx(EventForm, { teamId: mockTeamId, onSuccess: mockOnSuccess }) }));
...
//# sourceMappingURL=EventForm.test.js.map